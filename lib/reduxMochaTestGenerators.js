...
exports.shouldDispatchCorrectActionsWhenUnsuccessfulAsync = exports.shouldDispatchCorrectActionsWhenSuccessfulAsync = exports.shouldCreateActionWithCorrectPayload = undefined;
 ...
 * @param {string} message - the message for the assertion 
 */
var shouldDispatchCorrectActionsWhenSuccessfulAsync = exports.shouldDispatchCorrectActionsWhenSuccessfulAsync = function shouldDispatchCorrectActionsWhenSuccessfulAsync(describe, it, shouldWrapInDescribe, asyncActionCreator, expectedActions, setUpMocks, message) {
    if (!describe) {
        throw new Error('describe is required');
    }
 ...
 * @param {string} message - the message for the assertion 
 */
var shouldDispatchCorrectActionsWhenUnsuccessfulAsync = exports.shouldDispatchCorrectActionsWhenUnsuccessfulAsync = function shouldDispatchCorrectActionsWhenUnsuccessfulAsync(describe, it, shouldWrapInDescribe, asyncActionCreator, expectedActions, message) {
    if (!describe) {
        throw new Error('describe is required');
    }
    ...
    var shouldMessage = message ? message : 'should create the appropriate actions when unsuccessful';
